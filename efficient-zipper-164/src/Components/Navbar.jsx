...
function NavbarHome() {
 ...
 const {length,auth,authUser,login,loginUser}=useContext(AppContext)
  ...
  <Badge ml='1' fontSize='0.7em' colorScheme='green'>
    New
         ...
         <Link className='link' to="/admin">{auth?"Admin":""}</Link>
         ...
         <Search2Icon/>
          ...
          <div className='icon'>
           {auth || authUser ?<Button onClick={handleLogout}>Logout</Button>:
          <Link className='link' to="/login">  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-user"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg>
